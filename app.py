...
def preprocess_and_visualize(data, selected_grade):
    ...
    if '학년' in data.columns:
        ...
        has_elementary_4 = (filtered_data['학년'] == '초4').all()
        has_elementary_5 = (filtered_data['학년'] == '초5').all()
        has_elementary_6 = (filtered_data['학년'] == '초6').all()           
        has_middle = filtered_data['학년'].str.contains('중1|중2|중3').any()
        has_middle_1 = (filtered_data['학년'] == '중1').all()  
        has_middle_2 = (filtered_data['학년'] == '중2').all()
        has_middle_3 = (filtered_data['학년'] == '중3').all()
